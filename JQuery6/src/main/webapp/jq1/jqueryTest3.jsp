...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var c = $("h2").css('color','red'); // 속성에 값을 설정
		//1) 속성의 정보를 가져오기(확인)
		// ex) $("table").attr("border"); // 테이블 태그에  attr함수를 통해서 border 속성을 가져온다.
		...
		// h2 배경색 black, 글자색 : red, green, white
